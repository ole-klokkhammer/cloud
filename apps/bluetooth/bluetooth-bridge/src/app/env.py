...
# generic bluetooth
generic_ble_scan_cron = os.getenv("CRON_GENERIC_BLE_SCAN", "*/5 * * * *")

# airthings
airthings_wave_plus_sensor_data_cron = os.getenv("CRON_AIRTHINGS_WAVE_PLUS_SENSOR_DATA", "*/15 * * * *")
airthings_wave_plus_battery_cron = os.getenv("CRON_AIRTHINGS_WAVE_PLUS_BATTERY", "0 1 * * *")
