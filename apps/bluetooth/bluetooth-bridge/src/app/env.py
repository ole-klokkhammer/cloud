...
# generic bluetooth
generic_ble_scan_cron = os.getenv("GENERIC_BLE_SCAN_CRON", "*/5 * * * *")

# airthings
airthings_wave_plus_sensor_data_cron = os.getenv("AIRTHINGS_WAVE_PLUS_SENSOR_DATA_CRON", "*/15 * * * *")
airthings_wave_plus_battery_cron = os.getenv("AIRTHINGS_WAVE_PLUS_BATTERY_CRON", "0 1 * * *")
