import logging
import archive.k3s.bridges.bluetooth2amqp.src.app.bluetooth as bluetooth
import archive.k3s.bridges.bluetooth2amqp.src.app.bluetooth.tasks
...
def schedule_scan(scheduler):
    ...
    scheduler.add_job(
        archive.k3s.bridges.bluetooth2amqp.src.app.bluetooth.tasks.scan_and_publish,
        args=[
            archive.k3s.bridges.bluetooth2amqp.src.app.bluetooth.tasks.ScanAndPublishParams(
...
def schedule_connect(scheduler):
    ...
    for task in config[type]:
        ...
        scheduler.add_job(
            archive.k3s.bridges.bluetooth2amqp.src.app.bluetooth.tasks.connect_and_publish,
            args=[
                archive.k3s.bridges.bluetooth2amqp.src.app.bluetooth.tasks.ConnectAndPublishArgs(
...
def schedule_commands(scheduler):
    ...
    for task in config["command"]:
        ...
        scheduler.add_job(
            archive.k3s.bridges.bluetooth2amqp.src.app.bluetooth.tasks.send_command_and_publish,
            args=[
                archive.k3s.bridges.bluetooth2amqp.src.app.bluetooth.tasks.SendCommandAndPublishArgs(
                    address=address,
