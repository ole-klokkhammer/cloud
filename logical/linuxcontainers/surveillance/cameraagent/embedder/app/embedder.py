...
Watches the detector's stills dir, embeds new stills with a CLIP
...
POLL_DIR   = env('EMBEDDER_POLL_DIR', '/detector/events')
...
def insert_event(ts_iso, cls, still, vec):
    return pg_exec(
        'INSERT INTO events (ts, camera, class, still_path, embedding) '
