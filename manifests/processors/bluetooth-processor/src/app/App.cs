    ...
    public async Task RunAsync(string[] args)
    {
        var host = Host.CreateDefaultBuilder(args)
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddHostedService<BluetoothScanProcessor>();
                services.AddHostedService<RawAirthingsBatteryProcessor>();
                services.AddHostedService<ParsedAirthingsBatteryProcessor>();
                services.AddHostedService<RawAirthingsSensorProcessor>();
                services.AddHostedService<ParsedAirthingsSensorProcessor>();
            })
            .Build();
