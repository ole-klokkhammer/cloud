...
class PostProcessor:
    ...
    def start(self) -> None:
        if self.enable_restreamer:
            logger.info("Starting video_restreamer")
            self.video_restreamer.start()
        else:
            logger.info("Restreamer is not configured, skipping ... ")
    ...
    def stop(self) -> None:
        ...
        if self.enable_restreamer and self.video_restreamer is not None:
